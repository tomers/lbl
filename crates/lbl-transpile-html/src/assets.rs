...
.lbl-vertical{writing-mode:vertical-rl;text-orientation:upright;display:inline-block;vertical-align:middle;line-height:1;letter-spacing:calc((var(--lbl-vertical-spacing,1) - 1) * 1em)}
...
mod tests {
    ...
    fn base_css_includes_vertical_text() {
        ...
        assert!(BASE_CSS.contains("--lbl-vertical-spacing"));
        assert!(BASE_CSS.contains("letter-spacing:"));
    }
