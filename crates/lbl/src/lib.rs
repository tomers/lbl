...
pub use pipeline::{
    apply_virtual_feed_gaps, authoring_labels, encode_label, encode_label_from_rgba,
    encode_label_traced, encode_labels, encode_sample_pattern, encode_sample_pattern_traced,
    frame_html_preview_stock, pad_preview_encode_feed, pad_preview_encode_feed_plan, page_size_mm,
    preview_feed_plan, preview_stock_frame, render_label_raster, render_viewport_px,
    render_viewport_vector, resolve_label_align, resolve_label_fit, resolve_label_fit_scale,
    resolve_label_padding, resolve_label_padding_sides, resolve_label_valign, resolve_media,
    ...
    EncodeLabelsOptions, EncodeLabelsResult, LabelRaster, PipelineLayout, PipelineOptions,
    PreviewFeedOverrides, PreviewFeedPad, PreviewStockFrame, PreviewStockFrameParams, Source,
    TemplateFormat, TranspiledLabelHtml, VECTOR_CSS_DPI,
};
pub use preprocess::{
